...
public class ObesidadeGrau2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgCategoria.setImageResource(R.drawable.obesidade_dois);
        // Mensagem motivacional
        txtCategoria.append("\nCuidado! Seu IMC está em obesidade grau 2, o que pode aumentar os riscos de doenças como hipertensão e diabetes. Buscar ajuda médica pode ser essencial agora. Cada passo conta rumo ao seu bem-estar!");
